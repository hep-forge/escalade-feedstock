...
Feedstock license: [BSD-3-Clause](https://github.com/hep-forge/escalade-feedstock/blob/main/LICENSE.txt)
...
Note that all branches in the hep-forge/escalade-feedstock are
